...
from synaps.api.cloudwatch import cloudwatch2utils
...
class APIRequest(object):
    ...
    def invoke(self, context):
        try:
            method = getattr(
                self.controller,
                cloudwatch2utils.camelcase_to_underscore(self.action))
        ...
        args = cloudwatch2utils.dict_from_dotted_str(self.args.items())
