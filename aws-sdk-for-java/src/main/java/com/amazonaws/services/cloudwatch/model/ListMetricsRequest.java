...
public class ListMetricsRequest extends AmazonWebServiceRequest {
	...
	/**
     * The project_id to filter against.
     * <p>
     * <b>Constraints:</b><br/>
     * <b>Length: </b>1 - 255<br/>
     * <b>Pattern: </b>[^:].*<br/>
     ...
     * <b>Pattern: </b>[^:].*<br/>
     *
     * @return The project_id to filter against.
     */
     ...
     * <b>Pattern: </b>[^:].*<br/>
     *
     * @param project_id The project_id to filter against.
     */
     ...
     *         together. 
     */
    public ListMetricsRequest withProject_id(String project_id) {
        this.project_id = project_id;
        return this;
    }
    /**
