...
public class PutMetricDataRequest extends AmazonWebServiceRequest {
	...
	/**
     * The project_id for the metric data.
     * <p>
     * <b>Constraints:</b><br/>
     * <b>Length: </b>1 - 255<br/>
     * <b>Pattern: </b>[^:].*<br/>
     ...
     * <b>Pattern: </b>[^:].*<br/>
     *
     * @return The project_id for the metric data.
     */
     ...
     * <b>Pattern: </b>[^:].*<br/>
     *
     * @param project_id The project_id for the metric data.
     */
     ...
     *         together. 
     */
    public PutMetricDataRequest withProject_id(String project_id) {
        this.project_id = project_id;
        return this;
    }
