...
public class GetMetricStatisticsRequest extends AmazonWebServiceRequest {
     ...
     * <b>Pattern: </b>[^:].*<br/>
     *
     * @return The project_id of the metric.
     */
     ...
     * <b>Pattern: </b>[^:].*<br/>
     *
     * @param project_id The project_id of the metric.
     */
     ...
     *         together. 
     */
    public GetMetricStatisticsRequest withProject_id(String project_id) {
        this.project_id = project_id;
        return this;
    }
    /**
