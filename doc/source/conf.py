...
#man_pages = [
#    ('man/synapsmanage', 'synapsmanage', u'Cloud controller fabric',
#     [u'OpenStack'], 1)
# ]
...
latex_documents = [
  ('index', 'Synaps.tex', u'SPCS Synaps Documentation',
   u'Cloud Service Group, Samsung SDS', 'manual'),
]
